      ...
      <section className="mt-10">
        ...
        <dl className="mt-4 grid gap-x-8 gap-y-3 text-sm sm:grid-cols-2">
          <div>
            ...
            <dd className="font-medium">{profile.title} at {profile.company}</dd>
          </div>
          <div>
          ...
          <div>
            ...
            <dd>
              <a href={`mailto:${profile.email}`} className="font-medium text-[#2563eb] hover:underline">
                {profile.email}
              </a>
            </dd>
          </div>
          {profile.linkedin && profile.linkedin !== "LinkedIn URL pending" && (
            <div>
              ...
              <dd>
                <a href={profile.linkedin} target="_blank" rel="noreferrer" className="font-medium text-[#2563eb] hover:underline">
                  LinkedIn
                </a>
              </dd>
            </div>
